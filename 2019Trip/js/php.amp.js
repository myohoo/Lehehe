(function() {
	...
	k.prototype = {
					...
					case "_trackPageview":
						if(a[1]) {
							...
							if("" === a[2]) this.a.g = "";
								...
								var b = a[2];
								"http" !== b.substr(0,
									4) && (b = q + "//" + e[r].host, "/" !== a[2].charAt(0) && (b += "/"), b += a[2]);
								this.a.g = b
							}
							this.s();
		...
		sa: function() {
			try {
				if("" !== e[r].hash) return this.N = e[r].href
			} catch(a) {
				g(a, "gCP failed")
			}
		},
		...
		ua: function() {
			try {
				return this.a.B =
					e.navigator.systemLanguage || e.navigator.language, this.a.B = this.a.B.toLowerCase(), this.a.B
			} catch(a) {
				g(a, "gL failed")
			}
		},
		...
		ha: function() {
			try {
				return !1 ===
					e.navigator.cookieEnabled ? this.a.la = !1 : this.a.la = !0
			} catch(a) {
				g(a, "cCE failed")
			}
		},
		...
		ra: function(a) {
			try {
				h.cookie = a + "=; expires=" + (new Date(0)).toUTCString() +
					"; path=/"
			} catch(b) {
				g(b, "dAC failed")
			}
		...
		Z: function() {
			try {
				...
				if(1E8 < this.c) {
					...
					b.push(this.D);
					0 < b.length ? (a += f(b.join("|")), a +=
						"; expires=" + c.toUTCString(), a += "; path=/") : a += "; expires=" + (new Date(0)).toUTCString()
		...
		na: function(a, b) {
			try {
				...
				} else h.write(t("%3Cscript src='" + a + "' charset='" + b + "' type='text/javascript'%3E%3C/script%3E"))
			} catch(n) {
				g(n, "cAS failed")
			}
		},
		pa: function(a, b) {
			try {
				...
				if(c) {
					...
					d.src = a;
					c.appendChild(d)
				} else "0" === this.A && h.write(t("%3Cscript src='" + a + "' charset='" + b + "' type='text/javascript'%3E%3C/script%3E"))
			} catch(n) {
				g(n, "cSI failed")
			}
		},
		oa: function(a) {
			try {
				for(var b = a.length, c = "", d = 0; d < b; d++) a[d] && (c += t(a[d]));
		...
		s: function() {
			try {
				...
				b.push("id=" + f(this.c));
				this.a.g || "" === this.a.g ?
					b.push("r=" + f(this.a.g)) : b.push("r=" + f(this.a.Ha));
				...
				"[object String]" === {}.toString.call(this.u) &&
					b.push("ai=" + this.u);
				a && b.push("uuid=" + f(a));
				...
				b.push("h=1");
				var c = b.join("&");
				"[object String]" === {}.toString.call(this.v) ? this.j([q + "//ei.cnzz.com/stat.htm?" + c]) : this.F || this.u ? this.j([v + "/stat.htm?" + c]) : (this.W && this.j([q + "//" + this.W + "/stat.htm?" + c]), this.$ && this.j([q + "//" + this.$ + "/stat.htm?" + c]))
			} catch(d) {
				g(d, "sD failed")
			}
		},
